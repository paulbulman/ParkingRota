namespace ParkingRota.UnitTests.Pages
{
    ...
    public class SummaryModelTests
    {
        ...
        private static void CheckDay(
            SummaryModel.DisplayRequests displayRequests,
        ...
        private static void CheckRequests(IReadOnlyList<SummaryModel.DisplayRequest> actual, IReadOnlyList<string> expected)
        {
